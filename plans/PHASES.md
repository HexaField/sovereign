...
## Phase 10: Agent Core (beta release)
...
## Phase 11: Sovereignty & CI (initial release)
...
## Phase 12: Ecosystem (long-term vision)
...
**Critical path:** 1 → 2 → 3 → 6 → 9 → 10.session → 10.agent-loop → 10.multi-agent

**Parallel tracks:** Phase 5 alongside Phase 4–7. Phase 7 alongside Phase 6. Phase 8 alongside Phase 10. Radicle repo mgmt (Phase 4) enables P2P sync (Phase 11). VM CI independent. UI work runs in parallel with backend.
