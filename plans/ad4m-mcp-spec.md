...
AD4M is currently running on `user@10.0.0.2:12000` (WebSocket RPC, multi-user mode, confirmed initialized and live).
...
export interface Ad4mConfig {
  /** Base URL without path, e.g. "ws://10.0.0.2:12000" */
  host: string
