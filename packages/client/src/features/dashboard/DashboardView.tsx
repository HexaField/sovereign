// §7 Dashboard Feature — DashboardView + sub-components
...
// ── §7.1 DashboardView Component ──

export function DashboardView() {
  return (
    <div
      class="grid grid-cols-1 gap-4 p-4 md:grid-cols-2 lg:grid-cols-3"
      style={{ color: 'var(--c-text)', background: 'var(--c-bg)' }}
    >
      <div class="col-span-full text-4xl font-bold" style={{ color: 'var(--c-text-primary)' }}>
        {/* Clock */}
      </div>
      <div>{/* HealthPanel */}</div>
